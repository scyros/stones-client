      ...
      return {
        ...
        controller: [
          '$scope', '$element', '$attrs', '$transclude', function(scope, elm, attrs, transcludeFn) {
            ...
            if ($parse(attrs.stSelectFn)(scope) != null) {
              this.selectFn = $parse(attrs.stSelectFn)(scope);
            }
            if ($parse(attrs.stSortFn)(scope) != null) {
              this.sortFn = $parse(attrs.stSortFn)(scope);
            }
